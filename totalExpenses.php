...
<?php
include 'dbconn.php';
$queryMember = "SELECT Member_ID, Members from group_member WHERE Group_name = 'Group A'";
$resultMembers = mysqli_query($link, $queryMember) or die(mysqli_error($link));

$queryMember1 = "SELECT Member_ID, Members from group_member WHERE Group_name = 'Group A'";
$resultMember1 = mysqli_query($link, $queryMember1) or die(mysqli_error($link));

$queryMember2 = "SELECT Member_ID, Members from group_member WHERE Group_name = 'Group A'";
...
<html>
    <head>
        ...
        <script>
            $(document).ready(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "getTotalExpenses.php",
                    data: "currency=JPY",
                    cache: false,
                    dataType: "JSON",
                    success: function (response) {
                        if (response[0].Currency != null || response[0].totalAmt != null) {
                            $("caption#tableJPY").text("Total Expenses till date: " + response[0].Currency + " " + response[0].totalAmt);
                        } else {
                            $("h3#totalJPY").text("Total Expenses till date: JPY 0.00");
                            $("table#tableJPY").hide();
                        }
                    },
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response[0].Currency != null || response[0].totalAmt != null) {
                            ...
                            $("h3#totalSGD").text("Total Expenses till date: JPY 0.00");
                            $("table#tableSGD").hide();
                        }
                    },
                    error: function (obj, textStatus, errorThrown) {
                ...
                $.ajax({
                    type: "POST",
                    url: "getTotalExpensesByMember.php",
                    data: "memberID=1&currency=JPY",
                    cache: false,
                    dataType: "JSON",
                    success: function (response) {
    ...
    <body>
        <div id="tableJPY" style="border: 1px solid black; background-color: lightgrey;">
            <h3 id="totalJPY" style="font-family: Arial;"></h3>
            <table id="tableJPY">
                <caption id="tableJPY" style="font-family: Arial;">Total Expense till date: </caption>
        ...
        <div id="tableSGD" style="margin-top:10px; border: 1px solid black; background-color: lightgrey;">
            <h3 id="totalSGD" style="font-family: Arial;"></h3>
            <table id="tableSGD">
