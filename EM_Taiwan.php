...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Expense Management Korea</title>
        <!-- Required meta tags -->   
    ...
    <body style="background-image: url('img/background_kr.jpg'); background-repeat: no-repeat;
        ...
        <input type="button" id="logout" style="border-radius: 8px; float: right;" value="Log Out"/>
        <h1 style="color: darkblue; font-family: Arial;">Expense Management</h1>
        <form name="form" action="expensesTWDetails.php" method="GET">
            <h2 style="color: blue; font-weight: bolder; font-size: 40px; font-family: Arial;">Korea Trip 2022</h2> 
...
//                });
                ...
                $("input#totalExp").click(function () {
                    window.location = "totalTWExpenses.php";
                });
            });
        </script>
    </body>
