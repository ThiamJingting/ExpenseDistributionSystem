...
<html>
    ...
    <body style="background-image: url('img/background.jpg'); background-repeat: no-repeat;
        ...
        <form name="form" action="expensesDetails.php" method="GET">
            <h2 style="color: blue; font-weight: bolder; font-size: 40px; font-family: Arial;">Japan Trip 2020</h2> 
...
//                });
                ...
                $("input#totalExp").click(function () {
                    window.location = "totalExpenses.php";
                });
            });
        </script>
    </body>
